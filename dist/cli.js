...
function run() {
  ...
  var completePath = _path2.default.resolve(process.cwd(), process.env.CONFIG_FILE);
  var config = _lodash2.default.endsWith(process.env.CONFIG_FILE, '.js') ? require(completePath) : readJSONConfig(completePath);
